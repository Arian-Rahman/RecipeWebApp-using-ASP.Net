...
namespace RecipeWebApp.Controllers
{
    public class RecipesController : Controller
    {
        ...
        {
            return View("Index",await _context.Recipe.Where(j=> j.Title.Contains(SearchPhrase)).ToListAsync());
        }


        // Post: ShowSearchResults test
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description")] Recipe recipe)
        {
